...
3. Repository settings:
   - **Name**: `stefanlundchristensen.github.io`
...
git remote add origin https://github.com/stefanlundchristensen/stefanlundchristensen.github.io.git
...
```
https://stefanlundchristensen.github.io
```
...
| Type  | Name/Host | Value/Points To                           | TTL  |
|-------|-----------|-------------------------------------------|------|
| CNAME | www       | stefanlundchristensen.github.io          | 3600 |
...
1. Log into your Namecheap account at [namecheap.com](https://www.namecheap.com)
...
Click **Add New Record** and add each of these 4 records:
...
| Type         | Host | Value                                    | TTL       |
|--------------|------|------------------------------------------|-----------|
| CNAME Record | www  | stefanlundchristensen.github.io.        | Automatic |

**Important Namecheap Notes:**
- Make sure to use **@** as the Host for A records (not blank, not your domain name)
- For the CNAME, use **www** as the Host
- The CNAME Value should end with a dot: `stefanlundchristensen.github.io.`
- Delete any existing A or CNAME records that conflict (like parking page records)
- Delete the default URL Redirect Record if present

**Screenshot reference:** After adding, your Advanced DNS should look like:
```
Type          Host    Value                                TTL
A Record      @       185.199.108.153                     Automatic
A Record      @       185.199.109.153                     Automatic
...
4. Click **Add** to add each record
   ...
   - Type: CNAME, Name: www, Value: stefanlundchristensen.github.io
...
- Try accessing via `stefanlundchristensen.github.io` first
...
- [ ] Site loads at `stefanlundchristensen.github.io`
