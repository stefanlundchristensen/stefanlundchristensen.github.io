...
- **Platform teams should be product teams.** If your platform org measures success by "enabling others," you've already lost. Platform teams need their own users, their own metrics, and their own product roadmaps.

- **European payment fragmentation is a competitive advantage — for those who understand it.** Everyone complains about the complexity. The companies that win are the ones that build for it instead of around it.
...
- **Goal-setting frameworks matter far less than follow-through discipline.** I've seen teams with perfect OKRs deliver nothing and teams with a shared doc and weekly check-ins change the business. [More on that here](/posts/goal-setting/).
