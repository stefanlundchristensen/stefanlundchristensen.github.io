...
This is almost never practiced consistently. The reason is social: platform teams are pulled into the present by requests that feel urgent and reasonable. Saying no is uncomfortable. Being helpful is a natural instinct.
...
The mindsets are genuinely different. Not better or worse — different. You can't expect someone whose instinct is "what does the customer need now?" to suddenly think "what will every team need in six months?" It requires a different frame, and often different people.
...
This creates a structural incentive problem. Platform teams that optimize for visibility tend to drift toward features — things they can point to, things that generate gratitude. Platform teams that do the right work — deep infrastructure investment, reliability work, capability building — often have less to show in a quarterly review.
